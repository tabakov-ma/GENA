...
namespace Explorer
{
   partial class Expl
   {
      ...
      private void InitializeComponent()
      {
         ...
         ((System.ComponentModel.ISupportInitialize)(this.dgvObjectsDetails)).BeginInit();
         this.tableLayoutPanel1.SuspendLayout();
         this.tabPage2.SuspendLayout();
         ((System.ComponentModel.ISupportInitialize)(this.dgvObjects)).BeginInit();
         this.panelMemu.SuspendLayout();
         ((System.ComponentModel.ISupportInitialize)(this.spc_H2_H1_V)).BeginInit();
         this.spc_H2_H1_V.Panel1.SuspendLayout();
         this.spc_H2_H1_V.Panel2.SuspendLayout();
         this.spc_H2_H1_V.SuspendLayout();
         this.panelExplorer.SuspendLayout();
         ((System.ComponentModel.ISupportInitialize)(this.spc_H2_H)).BeginInit();
         this.spc_H2_H.Panel1.SuspendLayout();
         this.spc_H2_H.Panel2.SuspendLayout();
         this.spc_H2_H.SuspendLayout();
         ...
         // tabMenu
         // 
         this.tabMenu.Controls.Add(this.tbpMenu1);
         this.tabMenu.Controls.Add(this.tbpMenu2);
         ...
         // tbpMenu1
         // 
         this.tbpMenu1.Controls.Add(this.spc_H2_H1_V1_H);
         this.tbpMenu1.Location = new System.Drawing.Point(4, 25);
         ...
         // spc_H2_H1_V1_H
         // 
         this.spc_H2_H1_V1_H.Dock = System.Windows.Forms.DockStyle.Fill;
         this.spc_H2_H1_V1_H.Location = new System.Drawing.Point(4, 4);
         this.spc_H2_H1_V1_H.Margin = new System.Windows.Forms.Padding(4);
         this.spc_H2_H1_V1_H.Name = "spc_H2_H1_V1_H";
         this.spc_H2_H1_V1_H.Orientation = System.Windows.Forms.Orientation.Horizontal;
         // 
         ...
         this.trvObjects.FullRowSelect = true;
         this.trvObjects.HideSelection = false;
         this.trvObjects.HotTracking = true;
         this.trvObjects.Location = new System.Drawing.Point(0, 0);
         ...
         this.tableLayoutPanel3.Controls.Add(this.dgvObjectsDetails, 0, 1);
         ...
         // dgvObjectsDetails
         // 
         this.dgvObjectsDetails.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
         this.dgvObjectsDetails.Dock = System.Windows.Forms.DockStyle.Fill;
         this.dgvObjectsDetails.Location = new System.Drawing.Point(3, 33);
         ...
         // tabPage2
         // 
         this.tabPage2.Controls.Add(this.dgvObjects);
         ...
         this.dgvObjects.Location = new System.Drawing.Point(4, 4);
         ...
         // panelMemu
         // 
         this.panelMemu.Controls.Add(this.tabMenu);
         this.panelMemu.Dock = System.Windows.Forms.DockStyle.Fill;
         ...
         // spc_H2_H1_V
         // 
         this.spc_H2_H1_V.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
         this.spc_H2_H1_V.Dock = System.Windows.Forms.DockStyle.Fill;
         this.spc_H2_H1_V.Location = new System.Drawing.Point(0, 0);
         this.spc_H2_H1_V.Margin = new System.Windows.Forms.Padding(4);
         this.spc_H2_H1_V.Name = "spc_H2_H1_V";
         // 
         // spc_H2_H1_V.Panel1
         // 
         this.spc_H2_H1_V.Panel1.Controls.Add(this.panelMemu);
         // 
         // spc_H2_H1_V.Panel2
         // 
         ...
         this.spc_H2_H1_V.SplitterMoved += new System.Windows.Forms.SplitterEventHandler(this.spc_H2_H1_V_SplitMov);
         // 
         // panelExplorer
         // 
         this.panelExplorer.Controls.Add(this.tabExplorer);
         ...
         // spc_H2_H
         // 
         this.spc_H2_H.Dock = System.Windows.Forms.DockStyle.Fill;
         this.spc_H2_H.Location = new System.Drawing.Point(0, 0);
         this.spc_H2_H.Margin = new System.Windows.Forms.Padding(4);
         this.spc_H2_H.Name = "spc_H2_H";
         this.spc_H2_H.Orientation = System.Windows.Forms.Orientation.Horizontal;
         // 
         // spc_H2_H.Panel1
         // 
         this.spc_H2_H.Panel1.Controls.Add(this.spc_H2_H1_V);
         // 
         // spc_H2_H.Panel2
         // 
         ...
         this.spc_H.Margin = new System.Windows.Forms.Padding(4);
         ...
         this.mstMain.ShowItemToolTips = true;
         this.mstMain.Size = new System.Drawing.Size(1780, 28);
         this.mstMain.TabIndex = 0;
         this.mstMain.Text = "menuStrip1";
         // 
         // tsmFile
         // 
         this.tsmFile.Checked = true;
         ...
         this.ClientSize = new System.Drawing.Size(1780, 923);
         ...
         ((System.ComponentModel.ISupportInitialize)(this.dgvObjectsDetails)).EndInit();
         this.tableLayoutPanel1.ResumeLayout(false);
         this.tableLayoutPanel1.PerformLayout();
         this.tabPage2.ResumeLayout(false);
         ((System.ComponentModel.ISupportInitialize)(this.dgvObjects)).EndInit();
         this.panelMemu.ResumeLayout(false);
         this.spc_H2_H1_V.Panel1.ResumeLayout(false);
         this.spc_H2_H1_V.Panel2.ResumeLayout(false);
         ((System.ComponentModel.ISupportInitialize)(this.spc_H2_H1_V)).EndInit();
         this.spc_H2_H1_V.ResumeLayout(false);
         this.panelExplorer.ResumeLayout(false);
         this.spc_H2_H.Panel1.ResumeLayout(false);
         this.spc_H2_H.Panel2.ResumeLayout(false);
         this.spc_H2_H.Panel2.PerformLayout();
         ((System.ComponentModel.ISupportInitialize)(this.spc_H2_H)).EndInit();
         this.spc_H2_H.ResumeLayout(false);
         this.spc_H.Panel1.ResumeLayout(false);
         this.spc_H.Panel1.PerformLayout();
      ...
      private System.Windows.Forms.TabPage tbpMenu1;
      private System.Windows.Forms.TabPage tbpMenu2;
      private System.Windows.Forms.TabControl tabExplorer;
      private System.Windows.Forms.TabPage tabPage1;
      private System.Windows.Forms.Panel panelMemu;
      private System.Windows.Forms.SplitContainer spc_H2_H1_V;
      private System.Windows.Forms.Panel panelExplorer;
      private System.Windows.Forms.SplitContainer spc_H2_H;
