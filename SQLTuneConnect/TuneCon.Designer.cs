...
namespace SQLTuneCon
{
  partial class TuneCon
  {
    ...
    private void InitializeComponent()
    {
         ...
         this.barConnect = new System.Windows.Forms.ProgressBar();
         ...
         this.barLoadData = new System.Windows.Forms.ProgressBar();
         ...
         this.timLoadData = new System.Windows.Forms.Timer(this.components);
         this.toolTip_barLoadData = new System.Windows.Forms.ToolTip(this.components);
         this.tbxUserPass = new System.Windows.Forms.TextBox();
         ...
         // gbxTuneServer
         // 
         this.gbxTuneServer.Controls.Add(this.tbxUserPass);
         this.gbxTuneServer.Controls.Add(this.lblConnctYes);
         this.gbxTuneServer.Controls.Add(this.barConnect);
         ...
         // barConnect
         // 
         this.barConnect.Location = new System.Drawing.Point(6, 214);
         this.barConnect.Name = "barConnect";
         this.barConnect.Size = new System.Drawing.Size(451, 13);
         this.barConnect.TabIndex = 3;
         // 
         // cbxUserName
         // 
         ...
         // gbxCreateNewDB
         // 
         this.gbxCreateNewDB.Controls.Add(this.barLoadData);
         ...
         this.gbxCreateNewDB.Size = new System.Drawing.Size(461, 179);
         ...
         // barLoadData
         // 
         this.barLoadData.Location = new System.Drawing.Point(4, 158);
         this.barLoadData.Name = "barLoadData";
         this.barLoadData.Size = new System.Drawing.Size(451, 13);
         this.barLoadData.TabIndex = 18;
         // 
         // btnDeleteDB
         // 
         ...
         // timLoadData
         // 
         this.timLoadData.Interval = 1000;
         this.timLoadData.Tick += new System.EventHandler(this.timLoadData_Tick);
         // 
         // tbxUserPass
         // 
         this.tbxUserPass.Location = new System.Drawing.Point(281, 133);
         this.tbxUserPass.Name = "tbxUserPass";
         this.tbxUserPass.Size = new System.Drawing.Size(172, 20);
         this.tbxUserPass.TabIndex = 24;
         this.tbxUserPass.UseSystemPasswordChar = true;
         // 
         // TuneCon
         // 
         ...
         this.Text = "БД";
         this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.TuneCon_FormClosed);
    ...
    private System.Windows.Forms.ProgressBar barConnect;
  ...
  private System.Windows.Forms.Label lblSizeDB;
    ...
    private System.Windows.Forms.TextBox tbxCurNameTbl;
      ...
      private System.Windows.Forms.ProgressBar barLoadData;
      private System.Windows.Forms.Timer timLoadData;
      private System.Windows.Forms.ToolTip toolTip_barLoadData;
      private System.Windows.Forms.TextBox tbxUserPass;
   }
}
